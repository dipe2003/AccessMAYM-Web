...
public class EditarAccion implements Serializable {
    ...
    public List<Codificacion> getListaCodificaciones(){return this.ListaCodificaciones;}
    ...
    public void setListaAreasSectores(List<Area> ListaAreasSectores) {this.ListaAreasSectores = ListaAreasSectores;}
