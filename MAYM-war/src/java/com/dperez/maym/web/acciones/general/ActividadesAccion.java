...
public class ActividadesAccion implements Serializable {
    ...
    public int getIdActividadEditar() {
        return IdActividadEditar;
    }
    ...
    public TipoActividad[] getTiposDeActividad() {
        return this.tiposDeActividad;
    }
    //</editor-fold>

    //<editor-fold desc="Setters">
    public void setTipoDeActividad(TipoActividad tipoActividad) {
    ...
    public void setIdActividadEditar(int IdActividadEditar) {
        this.IdActividadEditar = IdActividadEditar;
    }
    ...
    public void setStrFechaEstimada(String strFechaEstimada) {
        ...
        try {
            this.fechaEstimada = sdf.parse(strFechaEstimada);
    ...
    public void setTiposDeActividad(TipoActividad[] tipos) {
    ...
    /**
     * Agrega una nueva medida correctiva a la accion correctiva. * Se persisten
     * los cambios. Se redirige a la vista de editar accion Muestra un mensaje
     * de error si no se pudo completar correctamente.
     *
    ...
    /**
     * Remueve la medida correctiva de la accion correctiva. Se persisten los
     * cambios. Muestra un mensaje de error si no se pudo completar
     * correctamente.
     *
     * @throws java.io.IOException
     */
    ...
    /**
     * Guarda los cambios realizados en la medida correctiva y los persiste. Se
     * redirige a la vista de editar la accion correctiva correspondiente si se
     * guardo, de lo contrario muestra un mensaje.
     *
     * @throws IOException
     */
