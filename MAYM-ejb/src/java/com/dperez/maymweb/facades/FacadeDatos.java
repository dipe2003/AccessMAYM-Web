...
public class FacadeDatos {
    ...
    /**
     * Crea una nueva accion en estado pendiente y la persiste en la base de
     * datos.
     *
     * @param tipoAccion
    ...
    /**
     * Crea el/los productos involucrados en el desvio, los agrega a la accion
     * correctiva y actualiza la base de datos.
     *
     * @param idAccion
    ...
    /**
     * Crea el/los adjuntos, los agrega a la accion y actualiza la base de
     * datos.
     *
     * @param idAccion
     * @param tituloAdjunto
    ...
    /**
     * Crea una nueva actividad de mejora, la persiste en la base de datos y se
     * asocia a la mejora.
     *
     * @param idAccion
    ...
    /**
     * Setea la fecha de implementacion de la Medida correctiva, cambia el
     * estado de la accion (si corresponde) y persiste los cambios en la base de
     * deatos.
     *
    ...
    /**
     * Setea la comprobacion de implementacion estimada con responsable y fecha
     * estimada. Actualiza la base de datos.
     *
     * @param fechaEstimada
    ...
    /**
     * Setea la comprobacion de eficacia estimada con responsable y fecha
     * estimada. Actualiza la base de datos.
     *
     * @param fechaEstimada
     * @param idUsuarioResponsable
    ...
    /**
     * Remueve la medida correctiva de la accion correctiva seleccionada y
     * actualiza la base de datos. Elimina la medida correctiva de la base de
     * datos.
     *
     * @param idAccion
     * @param idActividad
    ...
    /**
     * Remueve el archivo adjunto de la accion seleccionada y actualiza la base
     * de datos. Elimina el adjunto de la base de datos.
     *
     * @param idAccion
     * @param idAdjunto
    ...
    /**
     * Edita una accion con los mismos parametros que se creo.Actualiza la base
     * de datos.
     *
     * @param idAccion
     * @param fechaDeteccion
     ...
     * @return Retorna -1 si no se actualizo. Retorna el IdActividad si se
     * actualizo.
     */
    ...
    /**
     * Remueve el producto involucrado de la accion seleccionada y actualiza la
     * base de datos.Elimina el producto de la base de datos.
     *
     * @param idAccion
     * @param idProducto
     * @return Retorna -1 si no se actualizo. Retorna IdAccion si se actualizo.
     ...
     * @param idDeteccion
     * @param idAreaSector
     * @return Retorna el id de la fortaleza si se actualizo, de lo contrario
     * retorna -1.
     */
