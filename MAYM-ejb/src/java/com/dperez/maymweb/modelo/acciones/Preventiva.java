...
public class Preventiva extends Accion implements Serializable {
    ...
    // Constructores
    public Preventiva(Date fechaDeteccion, String descripcion, String referencias, Area area, Deteccion deteccion, Codificacion codificacion, Empresa empresa){
        super(fechaDeteccion, descripcion, referencias, area, deteccion, codificacion, empresa);
    }
    public Preventiva(){}
